...
namespace BDamigos
{
    public partial class Form1 : Form
    {
        ...
        {
            MySqlCommand SQL = new MySqlCommand("insert into tbl_amigos(amg_nome,amg_end,amg_cidade,amg_idade,amg_respon) values (@amgnome,@amgend,@amgcidade,@amgidade,@amgrespon)", mCon);
            ...
            SQL.Parameters.AddWithValue("@amgrespon", txtResponsavel.Text);
            SQL.ExecuteNonQuery();
